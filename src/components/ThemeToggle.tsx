...
export default function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="inline-flex h-9 w-9 items-center justify-center rounded-[var(--radius)] border border-line text-dim transition-colors hover:border-line-strong hover:text-ink"
    >
